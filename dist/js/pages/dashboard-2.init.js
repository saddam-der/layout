...
$(document).ready(function () {
  function e() {
    var a, e = ["#00acc1", "#f1556c"];
    (a = $("#lifetime-sales").data("colors")) && (e = a.split(",")), $("#lifetime-sales").sparkline([0, 23, 43, 35, 44, 45, 56, 37, 40], {
      type: "line",
      width: "100%",
      height: "220",
      chartRangeMax: 50,
      ...
      spotColor: !1,
      lineWidth: 1
    }), e = ["#00acc1"], (a = $("#income-amounts").data("colors")) && (e = a.split(",")), $("#income-amounts").sparkline([3, 6, 7, 8, 6, 4, 7, 10, 12, 7, 4, 9, 12, 13, 11, 12], {
      type: "bar",
      height: "220",
      barWidth: "10",
      barSpacing: "3",
      barColor: e
    }), e = ["#00acc1", "#4b88e4", "#e3eaef", "#fd7e14"], (a = $("#total-users").data("colors")) && (e = a.split(",")), $("#total-users").sparkline([20, 40, 30, 10], {
      type: "pie",
      width: "220",
      height: "220",
      sliceColors: e

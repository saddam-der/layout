...
<div class="auth-fluid">
        ...
        <div class="align-items-center d-flex h-100">
            <div class="card-body">
                ...
                <div class="text-center">
                    ...
                    <a href="index.html" class="btn btn-block btn-primary waves-effect waves-light mt-3">Back to Home</a>
                </div>
            </div>
            <!-- end .card-body -->
        </div>
    ...
    <div class="auth-fluid-right text-center">
        <div class="auth-user-testimonial">
            ...
            <p class="lead">
                <i class="mdi mdi-format-quote-open"></i> I've been using your theme
                from the previous developer for our web app, once I knew new version
                is out, I immediately bought with no hesitation. Great themes, good
                documentation with lots of customization available and sample app that
                really fit our need. <i class="mdi mdi-format-quote-close"></i>
            </p>

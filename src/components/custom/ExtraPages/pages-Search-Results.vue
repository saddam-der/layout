                    ...
                    <div class="search-result-box m-t-30 card-box">
                            ...
                            <div class="col-md-8 offset-md-2">
                                <div class="pt-3 pb-4">
                                    ...
                                    <div class="mt-3 text-center">
                                        <h5>Search Results For "Admin Dashboard"</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="home">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="search-item">
                                            <div class="media">
                                                <img class="d-flex mr-3 rounded-circle" src="../../../assets/images/users/user-1.jpg" alt="Generic placeholder image" height="54">
                            ...
                            <div class="tab-pane" id="users">
                                ...
                                <div class="search-item">
                                    <div class="media">
                                        <img class="d-flex mr-3 rounded-circle" src="../../../assets/images/users/user-2.jpg" alt="Generic placeholder image" height="54">
                                        <div class="media-body">
                                            <h5 class="mt-0">
                                ...
                                <div class="search-item">
                                    <div class="media">
                                        <img class="d-flex mr-3 rounded-circle" src="../../../assets/images/users/user-3.jpg" alt="Generic placeholder image" height="54">
                                        <div class="media-body">
                                            <h5 class="mt-0">
                                ...
                                <div class="search-item">
                                    <div class="media">
                                        <img class="d-flex mr-3 rounded-circle" src="../../../assets/images/users/user-4.jpg" alt="Generic placeholder image" height="54">
                                        <div class="media-body">
                                            <h5 class="mt-0">
                                ...
                                <div class="search-item">
                                    <div class="media">
                                        <img class="d-flex mr-3 rounded-circle" src="../../../assets/images/users/user-5.jpg" alt="Generic placeholder image" height="54">
                                        <div class="media-body">
                                            <h5 class="mt-0">

                        ...
                        <article class="timeline-item timeline-item-left">
                            <div class="timeline-desk">
                                <div class="timeline-box">
                                    ...
                                    <h4 class="mt-0 font-15">1 hour ago</h4>
                        ...
                        <article class="timeline-item">
                            <div class="timeline-desk">
                                <div class="timeline-box">
                                    ...
                                    <span class="timeline-icon"><i class="mdi mdi-adjust"></i></span>
                                    <h4 class="mt-0 font-15">2 hours ago</h4>
                                    <p class=" text-muted"><small>08:25 am</small></p>
                        ...
                        <article class="timeline-item timeline-item-left">
                            <div class="timeline-desk">
                                <div class="timeline-box">
                                    <span class="arrow-alt"></span>
                                    <span class="timeline-icon"><i class="mdi mdi-adjust"></i></span>
                                    <h4 class="mt-0 font-15">10 hours ago</h4>
                                    <p class="text-muted"><small>08:25 am</small></p>
                        ...
                        <article class="timeline-item">
                            <div class="timeline-desk">
                                <div class="timeline-box">
                                    <span class="arrow"></span>
                                    <span class="timeline-icon"><i class="mdi mdi-adjust"></i></span>
                                    <h4 class="mt-0 font-15">14 hours ago</h4>
                                    <p class="text-muted"><small>08:25 am</small></p>
                            ...
                            <div class="timeline-desk">
                                <div class="panel">
                                    <div class="timeline-box">
                                        <span class="arrow-alt"></span>
                                        <span class="timeline-icon"><i class="mdi mdi-adjust"></i></span>
                                        <h4 class="mt-0 font-15">19 hours ago</h4>
                                        <p class="text-muted"><small>08:25 am</small></p>
                            ...
                            <div class="timeline-desk">
                                <div class="panel">
                                    <div class="timeline-box">
                                        <span class="arrow"></span>
                                        <span class="timeline-icon"><i class="mdi mdi-adjust"></i></span>
                                        <h4 class="mt-0 font-15">07 January 2018</h4>
                                        <p class="text-muted"><small>08:25 am</small></p>
                            ...
                            <div class="timeline-desk">
                                <div class="panel">
                                    <div class="timeline-box">
                                        <span class="arrow-alt"></span>
                                        <span class="timeline-icon"><i class="mdi mdi-adjust"></i></span>
                                        <h4 class="mt-0 font-15">31 December 2017</h4>
                                        <p class="text-muted"><small>08:25 am</small></p>
                                        <p class="mb-0">Download the new updates of Ubold admin dashboard</p>
                                    </div>
                                </div>
                            ...
                            <div class="timeline-desk">
                                <div class="panel">
                                    <div class="timeline-box">
                                        <span class="arrow"></span>
                                        <span class="timeline-icon"><i class="mdi mdi-adjust"></i></span>
                                        <h4 class="mt-0 font-15">16 Decembar 2017</h4>
                                        <p class="text-muted"><small>08:25 am</small></p>

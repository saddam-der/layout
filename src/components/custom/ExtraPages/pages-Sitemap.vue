                ...
                <div class="col-12">
                    <div class="card-box">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <ul class="sitemap">
                                    <li><a href="javascript: void(0);" class="text-uppercase font-weight-bold"><i class="mdi mdi-adjust mr-1"></i>UBold Pages</a>
                                        <ul>
                            ...
                            <div class="col-lg-4">
                                <ul class="sitemap">
                                    <li><a href="javascript: void(0);" class="text-uppercase font-weight-bold"><i class="mdi mdi-adjust mr-1"></i>UBold</a>
                                        <ul>

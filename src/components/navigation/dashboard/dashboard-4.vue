        ...
        <div class="container-fluid">
            ...
            <div class="row">
                        ...
                        <div class="card-body" dir="ltr">
                            ...
                            <div id="cardCollpase1" class="collapse pt-3 show">
                                <div class="text-center">
                                    ...
                                    <donut-chart id="donut" :data="donutData" colors='[ "#FF6384", "#36A2EB", "#FFCE56" ]' resize="true">
                                    </donut-chart>
                ...
                <div class="col-xl-4 col-md-6">
                  ...
                  { "year": "2017", "and": 6},
                  { "year": "2018", "and": 7}
                  ]' xkey="year" ykeys='[ "and" ]' bar-colors='[ "#ff6384", "#36a2eb", "#ffce56"]' grid="true" resize="true">
                                    </bar-chart>
                                </div>
                            </div> <!-- end collapse-->
                        </div> <!-- end card-body-->
                        ...
                        <div class="card-body" dir="ltr">
                            ...
                            <div id="cardCollpase2" class="collapse pt-3 show">
                                <div class="text-center">
                                    ...
                                    <area-chart id="area" data='[
                    { year: "2012", a: 12, b:13},
                    { year: "2013", a: 12, b:13}
                  ]' xkey="year" ykeys='[ "a", "b" ]' bar-colors='[ "#ff6384", "#36a2eb"]' grid="true" resize="true">
                                    </area-chart>

      ...
      <div class="row">
        <div class="col-md-6 col-xl-3">
          <div class="card-box">
            ...
            <h4 class="mt-0 font-15">Income Status</h4>
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card-box">
            <i class="fa fa-info-circle text-muted float-right" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="More Info"></i>
            <h4 class="mt-0 font-15">Sales Status</h4>
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card-box">
            <i class="fa fa-info-circle text-muted float-right" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="More Info"></i>
            <h4 class="mt-0 font-15">Recent Users</h4>
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card-box">
            <i class="fa fa-info-circle text-muted float-right" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="More Info"></i>
            <h4 class="mt-0 font-15">Total Revenue</h4>
        ...
        <div class="col-xl-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="mt-3 chartjs-chart">
                <div id="chart">
                  <apexchart type="bar" height="290" :options="column" :series="ccolumn"></apexchart>
                </div>
              </div>
            </div>
          </div> <!-- end card-->

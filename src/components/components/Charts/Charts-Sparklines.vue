            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="card-box">
                        ...
                        <div class="mt-4">
                            <div id="sparkline1" data-colors="#4fc6e1,#7e57c2"></div>
                        </div>
                    </div> <!-- end card-box -->
                </div> <!-- end col -->
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card-box">
                        ...
                        <div class="mt-4">
                            <div id="sparkline2" data-colors="#7e57c2" class="text-center"></div>
                        </div>
                    </div> <!-- end card-box -->
                </div> <!-- end col -->
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card-box">
                        ...
                        <div class="mt-4">
                            <div id="sparkline3" data-colors="#4fc6e1,#f7b84b,#e3eaef,#7e57c2" class="text-center"></div>
                        </div>
                    </div> <!-- end card-box -->
                </div> <!-- end col -->
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card-box">
                        ...
                        <div class="mt-4">
                            <div id="sparkline4" data-colors="#7e57c2,#4eb7eb" class="text-center"></div>
                        </div>
                    </div> <!-- end card-box -->
                </div> <!-- end col -->
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card-box">
                        ...
                        <div class="text-center mt-4" style="min-height: 164px;">
                            <div id="sparkline9" data-colors="#4fc6e1,#7e57c2" class="text-center"></div>
                        </div>
                    </div> <!-- end card-box -->
                </div> <!-- end col -->
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card-box">
                        ...
                        <div class="text-center mt-4" style="min-height: 164px;">
                            <div id="sparkline10" data-colors="#7e57c2,#e3eaef,#ff679b" class="text-center"></div>
                        </div>
                    </div> <!-- end card-box -->
                </div> <!-- end col -->

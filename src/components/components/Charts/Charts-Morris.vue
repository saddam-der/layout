            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card-box" dir="ltr">
                        ...
                        <div id="morris-bar-stacked" style="height: 350px;" class="morris-chart" data-colors="#7e57c2,#4fc6e1,#e3eaef"></div>
                    </div> <!-- end card-box-->
                </div> <!-- end col-->
                ...
                <div class="col-lg-6">
                    <div class="card-box" dir="ltr">
                        ...
                        <div id="morris-area-example" style="height: 350px;" class="morris-chart" data-colors="#7e57c2,#4fc6e1"></div>
                    </div> <!-- end card-box-->
                </div> <!-- end col-->
            </div>
            <!-- end row -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card-box" dir="ltr">
                        ...
                        <div id="morris-line-example" style="height: 350px;" class="morris-chart" data-colors="#7e57c2,#4fc6e1"></div>
                    </div> <!-- card-box -->
                </div> <!-- end row -->
                ...
                <div class="col-lg-6">
                    <div class="card-box" dir="ltr">
                        ...
                        <div id="morris-bar-example" style="height: 350px;" class="morris-chart" data-colors="#7e57c2,#4fc6e1,#ebeff2"></div>
                    </div> <!-- end card-box-->
                </div> <!-- end col-->
            </div>
            <!-- end row -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card-box" dir="ltr">
                        ...
                        <div id="morris-area-with-dotted" style="height: 350px;" class="morris-chart" data-colors="#e3eaef,#7e57c2"></div>
                    </div> <!-- end card-box-->
                </div> <!-- end col-->
                ...
                <div class="col-lg-6">
                    <div class="card-box" dir="ltr">
                        ...
                        <div id="morris-donut-example" style="height: 350px;" class="morris-chart" data-colors="#7e57c2,#4fc6e1,#ebeff2"></div>
                        <div class="text-center">
                            <p class="text-muted font-15 font-family-secondary mb-0">

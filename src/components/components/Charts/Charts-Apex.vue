                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase1" class="collapse pt-3 show" dir="ltr">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div id="spark1" class="apex-charts" data-colors="#7e57c2"></div>
                                    </div>
                                    <div class="col-md-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase2" class="collapse pt-3 show" dir="ltr">
                                <div id="apex-line-1" class="apex-charts" data-colors="#7e57c2,#4fc6e1"></div>
                            </div> <!-- collapsed end -->
                        </div> <!-- end card-body -->
                    </div> <!-- end card-->
                </div> <!-- end col-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase4" class="collapse pt-3 show" dir="ltr">
                                <div id="apex-area" class="apex-charts" data-colors="#7e57c2,#f7b84b,#CED4DC"></div>
                            </div> <!-- collapsed end -->
                        </div> <!-- end card-body -->
                    </div> <!-- end card-->
                </div> <!-- end col-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase5" class="collapse pt-3 show" dir="ltr">
                                <div id="apex-column-1" class="apex-charts" data-colors="#7e57c2,#4fc6e1,#CED4DC"></div>
                            </div> <!-- collapsed end -->
                        </div> <!-- end card-body -->
                    </div> <!-- end card-->
                </div> <!-- end col-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase6" class="collapse pt-3 show" dir="ltr">
                                <div id="apex-column-2" class="apex-charts" data-colors="#7e57c2"></div>
                            </div> <!-- collapsed end -->
                        </div> <!-- end card-body -->
                    </div> <!-- end card-->
                </div> <!-- end col-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase7" class="collapse pt-3 show" dir="ltr">
                                <div id="apex-mixed-1" class="apex-charts" data-colors="#CED4DC,#7e57c2"></div>
                            </div> <!-- collapsed end -->
                        </div> <!-- end card-body -->
                    </div> <!-- end card-->
                </div> <!-- end col-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase8" class="collapse pt-3 show" dir="ltr">
                                <div id="apex-bar-1" class="apex-charts" data-colors="#4fc6e1"></div>
                            </div> <!-- collapsed end -->
                        </div> <!-- end card-body -->
                    </div> <!-- end card-->
                </div> <!-- end col-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase9" class="collapse pt-3 show" dir="ltr">
                                <div id="apex-bar-2" class="apex-charts" data-colors="#7e57c2,#4fc6e1"></div>
                            </div> <!-- collapsed end -->
                        </div> <!-- end card-body -->
                    </div> <!-- end card-->
                </div> <!-- end col-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase10" class="collapse pt-3 show" dir="ltr">
                                <div id="apex-mixed-2" class="apex-charts" data-colors="#7e57c2,#4fc6e1,#f672a7"></div>
                            </div> <!-- collapsed end -->
                        </div> <!-- end card-body -->
                    </div> <!-- end card-->
                </div> <!-- end col-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase11" class="collapse pt-3 show" dir="ltr">
                                <div id="apex-mixed-3" class="apex-charts" data-colors="#7e57c2,#ebf2f6,#f672a7"></div>
                            </div> <!-- collapsed end -->
                        </div> <!-- end card-body -->
                    </div> <!-- end card-->
                </div> <!-- end col-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase12" class="collapse pt-3 show" dir="ltr">
                                <div id="apex-bubble-1" class="apex-charts" data-colors="#7e57c2,#4fc6e1,#f672a7"></div>
                            </div> <!-- collapsed end -->
                        </div> <!-- end card-body -->
                    </div> <!-- end card-->
                </div> <!-- end col-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase13" class="collapse pt-3 show" dir="ltr">
                                <div id="apex-bubble-2" class="apex-charts" data-colors="#7e57c2,#4fc6e1,#f672a7,#6c757d"></div>
                            </div> <!-- collapsed end -->
                        </div> <!-- end card-body -->
                    </div> <!-- end card-->
                </div> <!-- end col-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase14" class="collapse pt-3 show" dir="ltr">
                                <div id="apex-scatter-1" class="apex-charts" data-colors="#4fc6e1,#f672a7,#6c757d"></div>
                            </div> <!-- collapsed end -->
                        </div> <!-- end card-body -->
                    </div> <!-- end card-->
                </div> <!-- end col-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase15" class="collapse pt-3 show" dir="ltr">
                                <div id="apex-scatter-2" class="apex-charts" data-colors="#4fc6e1,#f672a7,#6c757d,#7e57c2,#6559cc"></div>
                            </div> <!-- collapsed end -->
                        </div> <!-- end card-body -->
                    </div> <!-- end card-->
                </div> <!-- end col-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase16" class="collapse pt-3 show" dir="ltr">
                                <div id="apex-candlestick-1" class="apex-charts" data-colors="#7e57c2,#4fc6e1"></div>
                            </div> <!-- collapsed end -->
                        </div> <!-- end card-body -->
                    </div> <!-- end card-->
                </div> <!-- end col-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase17" class="collapse pt-3 show" dir="ltr">
                                <div id="apex-candlestick-2" class="apex-charts" data-colors="#7e57c2,#f7b84b"></div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase18" class="collapse pt-3 show" dir="ltr">
                                <div id="apex-pie-1" class="apex-charts" data-colors="#7e57c2,#4fc6e1,#4a81d4,#00b19d,#f1556c"></div>
                            </div> <!-- collapsed end -->
                        </div> <!-- end card-body -->
                    </div> <!-- end card-->
                </div> <!-- end col-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase19" class="collapse pt-3 show" dir="ltr">
                                <div id="apex-pie-2" class="apex-charts" data-colors="#7e57c2,#4fc6e1,#4a81d4,#00b19d,#f1556c"></div>
                            </div> <!-- collapsed end -->
                        </div> <!-- end card-body -->
                    </div> <!-- end card-->
                </div> <!-- end col-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase20" class="collapse pt-3 show" dir="ltr">
                                <div id="apex-pie-3" class="apex-charts" data-colors="#7e57c2,#4fc6e1,#4a81d4,#00b19d,#f1556c"></div>
                            </div> <!-- collapsed end -->
                        </div> <!-- end card-body -->
                    </div> <!-- end card-->
                </div> <!-- end col-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="cardCollpase22" class="collapse pt-3 show" dir="ltr">
                                <div id="apex-radialbar-2" class="apex-charts" data-colors="#7e57c2,#e36498,#23b397,#f7b84b"></div>
                            </div> <!-- collapsed end -->
                        </div> <!-- end card-body -->
                    </div> <!-- end card-->
                </div> <!-- end col-->

                        ...
                        <div class="row">
                            <div class="col-sm-6 col-xl-3">
                                <div class="p-2 text-center">
                                    ...
                                    <p class="text-muted font-14 mb-0">Lifetime Sales</p>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-xl-3">
                                <div class="p-2 text-center">
                                    ...
                                    <p class="text-muted font-14 mb-0">Income Amounts</p>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-xl-3">
                                <div class="p-2 text-center">
                                    ...
                                    <p class="text-muted font-14 mb-0">Total Users</p>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-xl-3">
                                <div class="p-2 text-center">
                                    ...
                                    <p class="text-muted font-14 mb-0">Total Visits</p>
                                </div>
                            </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="widget-rounded-circle card-box">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="avatar-lg">
                                    <img src="../../../assets/images/users/user-6.jpg" class="img-fluid rounded-circle" alt="user-img" />
                                </div>
                            </div>
                            <div class="col">

                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">Provide valuable, actionable feedback to your users with HTML5 form validation–available in all our supported browsers.</p>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">If your form layout allows it, you can swap the <code>.{valid|invalid}-feedback</code>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        ...
                        <p class="sub-header font-13">Parsley is a javascript form validation library. It helps you provide your users with feedback on

            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card-box">
                        ...
                        <p class="sub-header font-13">A lightweight and powerful datetimepicker</p>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card-box">
                        ...
                        <p class="sub-header font-13">Bootstrap Colorpicker is a modular color picker plugin for Bootstrap 4</p>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        ...
                        <p class="sub-header font-13">A clock-style timepicker for Bootstrap.</p>

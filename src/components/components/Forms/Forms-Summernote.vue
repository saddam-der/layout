                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">Super simple wysiwyg editor on Bootstrap</p>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">Air-mode give an interface without the Toolbar. To reveal popover Toolbar, select a text where you want to modify. Simply turn on <code>airMode</code> and just focus on text.</p>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">You can edit content on the fly.</p>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">Summernote supports autocomplete features, hint to help typing. You can define custom hints with options. Hint options can be an object or array for multiple hints.</p>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">For Emoji’s you can use <code>https://api.github.com/emojis</code></p>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">For Mentions: [jayden, sam, alvin, david]</p>

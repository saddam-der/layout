            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        ...
                        <p class="sub-header font-13">Add small overlays of content, like those on
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        ...
                        <p class="sub-header font-13">Four options are available: top, right, bottom,
                            and left aligned.</p>
                        ...
                        <p class="sub-header font-13">A highly customizable vanilla JS tooltip & popover library</p>

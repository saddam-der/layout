                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <img src="../../../assets/images/users/user-3.jpg" alt="image" class="img-fluid avatar-sm rounded mt-2">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <img src="../../../assets/images/users/user-7.jpg" alt="image" class="img-fluid avatar-md rounded-circle" />
                                    <p class="mt-1">
                                ...
                                <div class="col-md-4">
                                    <img src="../../../assets/images/users/user-8.jpg" alt="image" class="img-fluid avatar-lg rounded-circle" />
                                    <p>
                                ...
                                <div class="col-md-4">
                                    <img src="../../../assets/images/users/user-9.jpg" alt="image" class="img-fluid avatar-xl rounded-circle" />
                                    <p class="mb-0">

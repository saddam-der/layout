                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">Examples of custom modals.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">Specify the position for the modal. You can display modal at top, bottom, center or right of page by specifying
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">Show different contexual alert messages using modal component</p>

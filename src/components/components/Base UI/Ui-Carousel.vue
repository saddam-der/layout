                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">Here’s a carousel with slides only.
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">You can also add the indicators to the
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">Add captions to your slides easily with the <code>.carousel-caption</code> element within any <code>.carousel-item</code>.</p>

                            <div id="carouselExampleCaption" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner" role="listbox">
                                    <div class="carousel-item active">
                                        <img src="../../../assets/images/small/img-1.jpg" alt="..." class="d-block img-fluid">
                                    ...
                                    <div class="carousel-item">
                                        <img src="../../../assets/images/small/img-3.jpg" alt="..." class="d-block img-fluid">
                                        <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <div class="carousel-item">
                                        <img src="../../../assets/images/small/img-2.jpg" alt="..." class="d-block img-fluid">
                                        <div class="carousel-caption d-none d-md-block">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">Add <code>.carousel-fade</code> to your carousel to animate slides with a fade transition instead of a slide.</p>

                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">The most basic list group is an unordered list with list items and the proper classes.
                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">Add <code>.active</code> to a <code>.list-group-item</code> to indicate the current active selection.</p>
                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">Add <code>.disabled</code> to a <code>.list-group-item</code> to make it <em>appear</em> disabled.</p>
                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">Use <code>&lt;a&gt;</code>s or <code>&lt;button&gt;</code>s to create <em>actionable</em> list group items with hover, disabled, and active states by adding <code>.list-group-item-action</code>.</p>
                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">Add <code>.list-group-flush</code> to remove some borders and rounded corners to render list group items edge-to-edge in a parent container (e.g., cards).</p>
                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">Use contextual classes to style list items with a stateful background and color.</p>
                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">Add nearly any HTML within, even for linked list groups like the one below, with the help of flexbox utilities.</p>
                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">Add badges to any list group item to show unread counts, activity, and more with the help of some utilities.</p>

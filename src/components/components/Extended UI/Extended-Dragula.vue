                                    ...
                                    <div class="card mb-0 mt-3 border">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <a href="javascript: void(0);" class="text-reset">
                                                        <img src="../../../assets/images/users/user-5.jpg" alt="task-user" class="avatar-sm img-thumbnail rounded-circle">
                                    ...
                                    <div class="card mb-0 mt-3 border border-success">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <a href="javascript: void(0);" class="text-reset">
                                                        <img src="../../../assets/images/users/user-6.jpg" alt="task-user" class="avatar-sm img-thumbnail rounded-circle">
                                    ...
                                    <div class="card mb-0 mt-3 border">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <a href="javascript: void(0);" class="text-reset">
                                                        <img src="../../../assets/images/users/user-8.jpg" alt="task-user" class="avatar-sm img-thumbnail rounded-circle">
                                    ...
                                    <div class="card mb-0 mt-3 border">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <a href="javascript: void(0);" class="text-reset">
                                                        <img src="../../../assets/images/users/user-9.jpg" alt="task-user" class="avatar-sm img-thumbnail rounded-circle">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div id="company-list-left" class="py-2">
                                        ...
                                        <div class="card border rounded">
                                            <div class="card-body">
                                                <div class="media">
                                                    <img src="../../../assets/images/users/user-1.jpg" alt="image" class="mr-3 d-none d-sm-block avatar-sm rounded-circle">
                                        ...
                                        <div class="card border rounded">
                                            <div class="card-body">
                                                <div class="media">
                                                    <img src="../../../assets/images/users/user-2.jpg" alt="image" class="mr-3 d-none d-sm-block avatar-sm rounded-circle">
                                                    <div class="media-body">
                                        ...
                                        <div class="card border rounded">
                                            <div class="card-body">
                                                <div class="media">
                                                    <img src="../../../assets/images/users/user-3.jpg" alt="image" class="mr-3 d-none d-sm-block avatar-sm rounded-circle">
                                                    <div class="media-body">
                                    ...
                                    <div id="company-list-right" class="py-2">
                                        <div class="card border rounded">
                                            <div class="card-body p-3">
                                                <div class="media">
                                                    <img src="../../../assets/images/users/user-4.jpg" alt="image" class="mr-3 d-none d-sm-block avatar-sm rounded-circle">
                                                    <div class="media-body">
                                        ...
                                        <div class="card border rounded">
                                            <div class="card-body p-3">
                                                <div class="media">
                                                    <img src="../../../assets/images/users/user-5.jpg" alt="image" class="mr-3 d-none d-sm-block avatar-sm rounded-circle">
                                                    <div class="media-body">
                                        ...
                                        <div class="card border rounded">
                                            <div class="card-body p-3">
                                                <div class="media">
                                                    <img src="../../../assets/images/users/user-6.jpg" alt="image" class="mr-3 d-none d-sm-block avatar-sm rounded-circle">
                                                    <div class="media-body">
                                    ...
                                    <div class="bg-light p-2 p-lg-4">
                                        ...
                                        <div id="handle-dragula-left" class="py-2">
                                            ...
                                            <div class="card mb-0 mt-2">
                                                <div class="card-body">
                                                    <div class="media">
                                                        <img src="../../../assets/images/users/user-7.jpg" alt="image" class="mr-3 d-none d-sm-block avatar-sm rounded-circle">
                                                        <div class="media-body">
                                            ...
                                            <div class="card mb-0 mt-2">
                                                <div class="card-body">
                                                    <div class="media">
                                                        <img src="../../../assets/images/users/user-8.jpg" alt="image" class="mr-3 d-none d-sm-block avatar-sm rounded-circle">
                                                        <div class="media-body">
                                            ...
                                            <div class="card mb-0 mt-2">
                                                <div class="card-body">
                                                    <div class="media">
                                                        <img src="../../../assets/images/users/user-9.jpg" alt="image" class="mr-3 d-none d-sm-block avatar-sm rounded-circle">
                                                        <div class="media-body">
                                    ...
                                    <div class="bg-light p-2 p-lg-4">
                                        ...
                                        <div id="handle-dragula-right" class="py-2">
                                            <div class="card mb-0 mt-2">
                                                ...
                                                <div class="card-body p-3">
                                                    <div class="media">
                                                        <img src="../../../assets/images/users/user-10.jpg" alt="image" class="mr-3 d-none d-sm-block avatar-sm rounded-circle">
                                                        <div class="media-body">

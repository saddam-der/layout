                    ...
                    <div class="card-box">
                        ...
                        <div class="text-center">
                            <div id="animationSandbox">
                                <img src="../../../assets/images/macbook.png" alt="" class="img-fluid center-block">
                            </div>
                        </div>
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-append">
                                            <button class="btn btn-primary waves-light waves-effect js--triggerAnimation" type="button">Animate Me !
                                            </button>
                                        </span>
                                    </div>
                                    <!-- /input-group -->

                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">Scroll the area below the navbar and watch the active
                            ...
                            <nav id="navbar-example2" class="navbar navbar-light bg-light">
                                ...
                                <ul class="nav nav-pills">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle arrow-none" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Dropdown <i class="mdi mdi-chevron-down"></i></a>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header font-13">Scrollspy also works with nested <code>.nav</code>s.
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <nav id="navbar-example3" class="navbar navbar-light flex-column">
                                        ...
                                        <nav class="nav nav-pills flex-column">
                                            ...
                                            <nav class="nav nav-pills flex-column">
                                                <a class="nav-link ml-3 my-1 active" href="#item-1-1">Item 1-1</a>
                                ...
                                <div class="col-8">
                                    <div data-spy="scroll" data-target="#navbar-example3" data-offset="0" class="scrollspy-example" style="height: 350px;">

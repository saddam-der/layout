                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="font-13 text-muted text-uppercase">
                                Group Chats
                            </h6>
                            <div class="p-2">
                            ...
                            <h6 class="font-13 text-muted text-uppercase mb-2">
                                Contacts
                            </h6>
                                    ...
                                    <div data-simplebar style="max-height: 375px">
                                            ...
                                            <div class="media p-2">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="mt-0 mb-0 font-14">
                                                        <span class="float-right text-muted font-weight-normal font-11">4:30am</span>
                                                        Brandon Smith
                                                    </h5>
                                                    <p class="mt-1 mb-0 text-muted font-13">
                                        ...
                                        <a href="javascript:void(0);" class="text-body">
                                            <div class="media p-2">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="mt-0 mb-0 font-14">
                                                        <span class="float-right text-muted font-weight-normal font-11">5:30am</span>
                                                        James Z
                                                    </h5>
                                                    <p class="mt-1 mb-0 text-muted font-13">
                                        ...
                                        <a href="javascript:void(0);" class="text-body">
                                            <div class="media p-2">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="mt-0 mb-0 font-14">
                                                        <span class="float-right text-muted font-weight-normal font-11">Thu</span>
                                                        Maria C
                                                    </h5>
                                                    <p class="mt-1 mb-0 text-muted font-13">
                                                        <span class="w-25 float-right text-right"><span class="badge badge-soft-danger">2</span></span>
                                                        <span class="w-75">Are we going to have this week's planning
                                                            meeting today?</span>
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <a href="javascript:void(0);" class="text-body">
                                            <div class="media bg-light p-2">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="mt-0 mb-0 font-14">
                                                        <span class="float-right text-muted font-weight-normal font-11">Wed</span>
                                                        Rhonda D
                                                    </h5>
                                                    <p class="mt-1 mb-0 text-muted font-13">
                                        ...
                                        <a href="javascript:void(0);" class="text-body">
                                            <div class="media p-2">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="mt-0 mb-0 font-14">
                                                        <span class="float-right text-muted font-weight-normal font-11">Tue</span>
                                                        Michael H
                                                    </h5>
                                                    <p class="mt-1 mb-0 text-muted font-13">
                                                        <span class="w-75">Are you free for 15 min? I would like to
                                        ...
                                        <a href="javascript:void(0);" class="text-body">
                                            <div class="media p-2">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="mt-0 mb-0 font-14">
                                                        <span class="float-right text-muted font-weight-normal font-11">Mon</span>
                                                        Ricky J
                                                    </h5>
                                                    <p class="mt-1 mb-0 text-muted font-13">
                            ...
                            <ul class="conversation-list" data-simplebar style="max-height: 460px">
                                <li class="clearfix">
                                    ...
                                    <div class="conversation-actions dropdown">
                                        <button class="btn btn-sm btn-link" data-toggle="dropdown" aria-expanded="false">
                                ...
                                <li class="clearfix">
                                    ...
                                    <div class="conversation-text">
                                        <div class="ctext-wrap">
                                            <i>James Z</i>
                                            <p>
                                                Sorry, I have another meeting scheduled at 2pm.
                                                Can we have it at 3pm instead?
                                            </p>
                                        </div>
                                    </div>
                                    <div class="conversation-actions dropdown">
                                ...
                                <li class="clearfix">
                                    ...
                                    <div class="conversation-text">
                                        <div class="ctext-wrap">
                                            <i>James Z</i>
                                            <p>
                                                We can also discuss about the presentation talk
                                                format if you have some extra mins
                                            </p>
                                        </div>
                                    </div>
                                    <div class="conversation-actions dropdown">

                            ...
                            <div class="col-sm-4">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mt-0 mb-2 font-15">Amazon Inc.</h4>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-4">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mt-0 mb-2 font-15">Apple Inc.</h4>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-4">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mt-0 mb-2 font-15">Google LLC</h4>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-4">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mt-0 mb-2 font-15">Airbnb Inc.</h4>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-4">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mt-0 mb-2 font-15">Cisco Systems</h4>
                ...
                <div class="col-lg-4 order-lg-2 order-1">
                    <div class="card-box">
                        ...
                        <div class="text-center" dir="ltr">
                            ...
                            <p class="text-muted font-14 font-family-secondary mb-0 mt-3">

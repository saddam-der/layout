                ...
                <div class="col-lg-4">
                    <div class="card-box bg-pattern">
                        <div class="text-center">
                            ...
                            <h4 class="mb-1 font-16">Amazon Inc.</h4>
                        ...
                        <div class="row mt-4 text-center">
                            <div class="col-6">
                                <h5 class="font-weight-normal text-muted font-13">Revenue (USD)</h5>
                                <h4>17,786 cr</h4>
                            </div>
                            <div class="col-6">
                                <h5 class="font-weight-normal text-muted font-13">Number of employees</h5>
                                <h4>566k</h4>
                            </div>
                        </div>
                    </div> <!-- end card-box -->
                ...
                <div class="col-lg-4">
                    <div class="card-box bg-pattern">
                        <div class="text-center">
                            ...
                            <h4 class="mb-1 font-16">Apple Inc.</h4>
                ...
                <div class="col-lg-4">
                    <div class="card-box bg-pattern">
                        <div class="text-center">
                            ...
                            <h4 class="mb-1 font-16">Google LLC</h4>
                ...
                <div class="col-lg-4">
                    <div class="card-box bg-pattern">
                        <div class="text-center">
                            ...
                            <h4 class="mb-1 font-16">Airbnb Inc.</h4>
                ...
                <div class="col-lg-4">
                    <div class="card-box bg-pattern">
                        <div class="text-center">
                            ...
                            <h4 class="mb-1 font-16">Facebook Inc.</h4>
                ...
                <div class="col-lg-4">
                    <div class="card-box bg-pattern">
                        <div class="text-center">
                            ...
                            <h4 class="mb-1 font-16">Cisco Systems</h4>

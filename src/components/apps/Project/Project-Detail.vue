                ...
                <div class="col-xl-8 col-lg-6">
                    ...
                    <div class="card d-block">
                        <div class="card-body">
                            ...
                            <h5 class="font-14">Project Overview:</h5>
                            ...
                            <div>
                                <h5 class="font-14">Team Members:</h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="mt-0 mb-3 font-16">Comments (258)</h4>
                            ...
                            <div class="mt-2">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="media mt-3">
                                            ...
                                            <div class="media-body">
                                                <h5 class="mt-0 font-14"><a href="contacts-profile.html" class="text-reset">Kathleen Thomas</a> <small class="text-muted">1 hours ago</small></h5>
                                ...
                                <div class="media mt-3">
                                    ...
                                    <div class="media-body">
                                        <h5 class="mt-0 font-14"><a href="contacts-profile.html" class="text-reset">Jonathan Tiner</a> <small class="text-muted">1 day ago</small></h5>

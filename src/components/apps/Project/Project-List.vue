...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-sm-4">
                    <a href="project-create.html" class="btn btn-danger btn-rounded waves-effect waves-light mb-3"><i class="mdi mdi-plus"></i> Create Project</a>
                </div>
                <div class="col-sm-8">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card-box project-box">
                        ...
                        <!-- Title-->
                        <h5 class="mt-0"><a href="project-detail.html" class="text-dark">New Admin Design</a></h5>
                ...
                <div class="col-lg-4">
                    <div class="card-box project-box">
                        ...
                        <!-- Title-->
                        <h5 class="mt-0"><a href="project-detail.html" class="text-dark">App Design and Development</a></h5>
                ...
                <div class="col-lg-4">
                    <div class="card-box project-box">
                        ...
                        <!-- Title-->
                        <h5 class="mt-0"><a href="project-detail.html" class="text-dark">Landing page Design</a></h5>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card-box project-box">
                        ...
                        <!-- Title-->
                        <h5 class="mt-0"><a href="project-detail.html" class="text-dark">Custom Software Development</a></h5>
                ...
                <div class="col-lg-4">
                    <div class="card-box project-box">
                        ...
                        <!-- Title-->
                        <h5 class="mt-0"><a href="project-detail.html" class="text-dark">Website Redesign</a></h5>
                ...
                <div class="col-lg-4">
                    <div class="card-box project-box">
                        ...
                        <!-- Title-->
                        <h5 class="mt-0"><a href="project-detail.html" class="text-dark">Multipurpose Landing Template</a></h5>

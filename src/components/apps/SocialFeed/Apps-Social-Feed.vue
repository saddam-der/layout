                ...
                <div class="col-xl-3 col-lg-6 order-lg-1 order-xl-1">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="media">
                                <img class="d-flex align-self-start rounded mr-2" src="../../../assets/images/users/user-1.jpg" alt="Dominic Keller" height="48">
                            ...
                            <div class="list-group list-group-flush mt-2 font-14">
                                <a href="javascript:void(0);" class="list-group-item list-group-item-action text-primary font-weight-medium border-0"><i class='mdi mdi-image-filter-black-white font-16 mr-1'></i> News Feed</a>
                            ...
                            <div class="px-2">
                                <div class="media mb-2">
                                    ...
                                    <div class="media-body pl-2">
                                        ...
                                        <h5 class="mt-1 mb-0 font-family-primary font-weight-medium font-13"><a href="javascript: void(0);" class="text-reset">Football Team</a></h5>
                                    </div>
                                </div>
                                ...
                                <div class="media mb-2">
                                    ...
                                    <div class="media-body pl-2">
                                        <h5 class="mt-1 mb-0 font-family-primary font-weight-medium font-13"><a href="javascript: void(0);" class="text-reset">UI/UX Community</a></h5>
                                    </div>
                                </div>
                                ...
                                <div class="media mb-2">
                                    ...
                                    <div class="media-body pl-2">
                                        <h5 class="mt-1 mb-0 font-family-primary font-weight-medium font-13"><a href="javascript: void(0);" class="text-reset">Web Designer</a></h5>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-box">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <h5 class="m-0 font-14"><a href="contacts-profile.html" class="text-reset">Jeremy Tomlinson</a></h5>
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <img src="../../../assets/images/small/img-4.jpg" alt="post-img" class="rounded mr-1 mb-3 mb-sm-0 img-fluid">
                            </div>
                            <div class="col">
                                <img src="../../../assets/images/small/img-1.jpg" alt="post-img" class="rounded mr-1 img-fluid mb-3">
                                <img src="../../../assets/images/small/img-3.jpg" alt="post-img" class="rounded mr-1 img-fluid">
                            </div>
                        </div>
                        ...
                        <div class="media mt-3">
                            <img src="../../../assets/images/users/user-1.jpg" height="32" class="align-self-start rounded mr-2" alt="Arya Stark">
                            <div class="media-body">
                    ...
                    <div class="card-box">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <h5 class="m-0 font-14"><a href="contacts-profile.html" class="text-reset">Thelma Fridley</a></h5>
                        ...
                        <div class="post-user-comment-box mt-2">
                            <div class="media">
                                <img class="mr-2 avatar-sm rounded-circle" src="../../../assets/images/users/user-3.jpg" alt="Generic placeholder image">
                                <div class="media-body">
                                    <h5 class="mt-0 font-14"><a href="contacts-profile.html" class="text-reset">Jeremy Tomlinson</a> <small class="text-muted">3 hours ago</small></h5>
                                    ...
                                    <div class="media mt-3">
                                        ...
                                        <div class="media-body">
                                            <h5 class="mt-0 font-14"><a href="contacts-profile.html" class="text-reset">Kathleen Thomas</a> <small class="text-muted">5 hours ago</small></h5>
                    ...
                    <div class="card-box">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <h5 class="m-0 font-14"><a href="contacts-profile.html" class="text-reset">Jonathan Tiner</a></h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="media mt-3">
                                ...
                                <div class="media-body">
                                    <a class="mt-1 font-13 text-reset" href="javascript:void(0);">

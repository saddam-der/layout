            ...
            <div class="row">
                <div class="col-lg-4 col-xl-4">
                    <div class="card-box text-center">
                        ...
                        <h4 class="mb-0 font-16">Geneva McKnight</h4>
                            ...
                            <div class="tab-pane show active" id="timeline">
                                ...
                                <div class="border border-light p-2 mb-3">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h5 class="m-0 font-14">Jeremy Tomlinson</h5>
                                ...
                                <div class="border border-light p-2 mb-3">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h5 class="m-0 font-14">Thelma Fridley</h5>
                                            <p class="text-muted"><small>about 1 hour ago</small></p>
                                        </div>
                                    </div>
                                    <div class="font-15 text-center font-italic text-dark">
                                    ...
                                    <div class="post-user-comment-box">
                                        <div class="media">
                                            <img class="mr-2 avatar-sm rounded-circle" src="../../../assets/images/users/user-3.jpg" alt="Generic placeholder image">
                                            <div class="media-body">
                                                <h5 class="mt-0 font-14">Jeremy Tomlinson <small class="text-muted">3 hours ago</small></h5>
                                                ...
                                                <div class="media mt-3">
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="mt-0 font-14">Kathleen Thomas <small class="text-muted">5 hours ago</small></h5>

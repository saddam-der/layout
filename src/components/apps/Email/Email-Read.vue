                    ...
                    <div class="card-box">
                        ...
                        <div class="inbox-leftbar">
                            ...
                            <div class="mail-list mt-4">
                                <a href="javascript: void(0);" class="text-danger font-weight-bold font-14"><i class="dripicons-inbox mr-2"></i>Inbox<span class="badge badge-soft-danger float-right ml-2">7</span></a>
                                <a href="javascript: void(0);" class="font-14"><i class="dripicons-star mr-2"></i>Starred</a>
                                <a href="javascript: void(0);" class="font-14"><i class="dripicons-clock mr-2"></i>Snoozed</a>
                                <a href="javascript: void(0);" class="font-14"><i class="dripicons-document mr-2"></i>Draft<span class="badge badge-soft-info float-right ml-2">32</span></a>
                                <a href="javascript: void(0);" class="font-14"><i class="dripicons-exit mr-2"></i>Sent Mail</a>
                                <a href="javascript: void(0);" class="font-14"><i class="dripicons-trash mr-2"></i>Trash</a>
                                <a href="javascript: void(0);" class="font-14"><i class="dripicons-tag mr-2"></i>Important</a>
                                <a href="javascript: void(0);" class="font-14"><i class="dripicons-warning mr-2"></i>Spam</a>
                            </div>

                            <h6 class="mt-4">Labels</h6>

                            <div class="list-group b-0 mail-list">
                                <a href="#" class="list-group-item border-0 font-14"><span class="mdi mdi-circle text-info mr-2"></span>Web App</a>
                                <a href="#" class="list-group-item border-0 font-14"><span class="mdi mdi-circle text-warning mr-2"></span>Recharge</a>
                                <a href="#" class="list-group-item border-0 font-14"><span class="mdi mdi-circle text-dark mr-2"></span>Wallet Balance</a>
                                <a href="#" class="list-group-item border-0 font-14"><span class="mdi mdi-circle text-primary mr-2"></span>Friends</a>
                                <a href="#" class="list-group-item border-0 font-14"><span class="mdi mdi-circle text-success mr-2"></span>Family</a>
                            </div>

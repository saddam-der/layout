                                    ...
                                    <div class="row mt-4" data-plugin="dragula" data-containers='["task-list-one", "task-list-two", "task-list-three"]'>
                                        <div class="col">
                                            <a class="text-dark" data-toggle="collapse" href="#todayTasks" aria-expanded="false" aria-controls="todayTasks">
                                                <h5 class="mb-0 font-14"><i class='mdi mdi-chevron-down font-18'></i> Today <span class="text-muted font-12">(10)</span></h5>
                                            </a>
                                                    ...
                                                    <div class="card-body pb-0" id="task-list-one">
                                                        ...
                                                        <div class="row justify-content-sm-between task-item">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="d-sm-flex justify-content-between">
                                                                    <div>
                                                                        <img src="../../../assets/images/users/user-2.jpg" alt="image" class="avatar-xs rounded-circle" data-toggle="tooltip" data-placement="bottom" title="Assigned to James B" />
                                                                    </div>
                                                                    <div class="mt-3 mt-sm-0">
                                                                        <ul class="list-inline font-13 text-sm-right">
                                                                            <li class="list-inline-item pr-1">
                                                        ...
                                                        <div class="row justify-content-sm-between task-item">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="d-sm-flex justify-content-between">
                                                                    <div>
                                                                        <img src="../../../assets/images/users/user-4.jpg" alt="image" class="avatar-xs rounded-circle" data-toggle="tooltip" data-placement="bottom" title="Assigned to Kevin C" />
                                                                    </div>
                                                                    <div class="mt-3 mt-sm-0">
                                                                        <ul class="list-inline font-13 text-sm-right">
                                                                            <li class="list-inline-item pr-1">
                                            ...
                                            <div class="mt-4">
                                                <a class="text-dark" data-toggle="collapse" href="#upcomingTasks" aria-expanded="false" aria-controls="upcomingTasks">
                                                    <h5 class="mb-0 font-14">
                                                        <i class='mdi mdi-chevron-down font-18'></i> Upcoming <span class="text-muted font-12">(5)</span>
                                                    </h5>
                                                </a>
                                                        ...
                                                        <div class="card-body pb-0" id="task-list-two">
                                                            ...
                                                            <div class="row justify-content-sm-between task-item">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="d-sm-flex justify-content-between">
                                                                        <div>
                                                                            <img src="../../../assets/images/users/user-7.jpg" alt="image" class="avatar-xs rounded-circle" data-toggle="tooltip" data-placement="bottom" title="Assigned to Edward S" />
                                                                        </div>
                                                                        <div class="mt-3 mt-sm-0">
                                                                            <ul class="list-inline font-13 text-sm-right">
                                                                                <li class="list-inline-item pr-1">
                                            ...
                                            <div class="mt-4">
                                                <a class="text-dark" data-toggle="collapse" href="#otherTasks" aria-expanded="false" aria-controls="otherTasks">
                                                    <h5 class="font-14">
                                                        <i class='mdi mdi-chevron-down font-18'></i> Other <span class="text-muted font-12">(5)</span>
                                                    </h5>
                                                </a>
                                                        ...
                                                        <div class="card-body pb-0" id="task-list-three">
                                                            ...
                                                            <div class="row justify-content-sm-between task-item">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="d-sm-flex justify-content-between">
                                                                        <div>
                                                                            <img src="../../../assets/images/users/user-9.jpg" alt="image" class="avatar-xs rounded-circle" data-toggle="tooltip" data-placement="bottom" title="Assigned to Arya S" />
                                                                        </div>
                                                                        <div class="mt-3 mt-sm-0">
                                                                            <ul class="list-inline font-13 text-sm-right">
                                                                                <li class="list-inline-item pr-1">
                                                            ...
                                                            <div class="row justify-content-sm-between task-item">
                                                                <div class="col-lg-6 mb-2">
                                                                    <div class="custom-control custom-checkbox">
                                                                        <input type="checkbox" class="custom-control-input" id="task11">
                                                            ...
                                                            <div class="row justify-content-sm-between task-item">
                                                                <div class="col-lg-6 mb-2">
                                                                    <div class="custom-control custom-checkbox">
                                                                        <input type="checkbox" class="custom-control-input" id="task12">
                                                            ...
                                                            <div class="row justify-content-sm-between task-item">
                                                                <div class="col-lg-6 mb-2">
                                                                    <div class="custom-control custom-checkbox">
                                                                        <input type="checkbox" class="custom-control-input" id="task13">
                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <h5>Simple Admin Dashboard Template Design</h5>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col">
                                            ...
                                            <div class="media mt-3 p-1">
                                                <img src="../../../assets/images/users/user-9.jpg" class="mr-2 rounded-circle" height="36" alt="Arya Stark" />
                                                <div class="media-body">
                                                    <h5 class="mt-0 mb-0 font-14">
                                                        <span class="float-right text-muted font-11">4:30am</span>
                                                        Arya Stark
                                                    </h5>
                                            ...
                                            <div class="media mt-2 p-1">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="mt-0 mb-0 font-14">
                                                        <span class="float-right text-muted font-11">3:30am</span>
                                                        Gary Somya
                                                    </h5>
                                                    <p class="mt-1 mb-0 text-muted">

                ...
                <div class="col-xl-8 col-lg-7">
                    ...
                    <div class="card d-block">
                        <div class="card-body">
                            ...
                            <h4 class="font-16">Simple Admin Dashboard Template Design</h4>
                            ...
                            <h5 class="mt-3 font-14">Overview:</h5>
                            ...
                            <h5 class="mt-4 mb-2 font-14">Checklists/Sub-tasks</h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="mb-4 mt-0 font-15">Comments (51)</h4>

                            <div class="clerfix"></div>

                            <div class="media">
                                <img class="mr-2 rounded-circle" src="../../../assets/images/users/user-3.jpg" alt="Generic placeholder image" height="32">
                                <div class="media-body">
                                    ...
                                    <div class="media mt-3">
                                        <a class="pr-2" href="#">
                                            <img src="../../../assets/images/users/user-4.jpg" class="rounded-circle" alt="Generic placeholder image" height="32">
                                        </a>
                                        <div class="media-body">
                            ...
                            <div class="media mt-3">
                                <img class="mr-2 rounded-circle" src="../../../assets/images/users/user-5.jpg" alt="Generic placeholder image" height="32">
                                <div class="media-body">

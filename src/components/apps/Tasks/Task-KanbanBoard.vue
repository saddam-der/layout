                                ...
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <div class="text-right">
                                            ...
                                            <a href="javascript: void(0);" class="text-muted">
                                                <img src="../../../assets/images/users/user-7.jpg" alt="task-user" class="avatar-sm img-thumbnail rounded-circle">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <div class="text-right">
                                            ...
                                            <a href="javascript: void(0);" class="text-muted">
                                                <img src="../../../assets/images/users/user-10.jpg" alt="task-user" class="avatar-sm img-thumbnail rounded-circle">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="task-success" id="task11">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <div class="text-right">
                                            <a href="javascript: void(0);" class="text-muted">
                                                <img src="../../../assets/images/users/user-4.jpg" alt="task-user" class="avatar-sm img-thumbnail rounded-circle">
                                            </a>
                                            <a href="javascript: void(0);" class="text-muted">
                                                <img src="../../../assets/images/users/user-7.jpg" alt="task-user" class="avatar-sm img-thumbnail rounded-circle">
                                            </a>

                ...
                <div class="col-xl-8 col-lg-7">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="media">
                                        <img src="../../../assets/images/users/user-2.jpg" alt="Arya S" class="rounded-circle mr-2" height="24" />
                                        <div class="media-body">
                                            <p> Thelma Fridley </p>
                                        </div>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="mb-4 mt-0 font-15">Discussion (68)</h4>

                            <div class="clerfix"></div>

                            <div class="media">
                                <img class="mr-2 rounded-circle" src="../../../assets/images/users/user-9.jpg" alt="Generic placeholder image" height="32">
                                <div class="media-body">
                                    <h5 class="mt-0 mb-1 font-14">Jonathan Andrews <small class="text-muted float-right">3 hours ago</small></h5>
                            ...
                            <div class="media mt-3">
                                <img class="mr-2 rounded-circle" src="../../../assets/images/users/user-2.jpg" alt="Generic placeholder image" height="32">
                                <div class="media-body">
                                    <h5 class="mt-0 mb-1 font-14">Thelma Fridley <small class="text-muted float-right">5 hours ago</small></h5>
                            ...
                            <div class="media mt-3">
                                <a class="pr-2" href="#">
                                    <img src="../../../assets/images/users/user-9.jpg" class="rounded-circle" alt="Generic placeholder image" height="32">
                                </a>
                                <div class="media-body">
                                    <h5 class="mt-0 mb-1 font-14">Jonathan Andrews <small class="text-muted float-right">1 day ago</small></h5>
                            ...
                            <div class="card mb-1 shadow-none border">
                                <div class="p-2">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col pl-0">
                                            <a href="javascript:void(0);" class="text-muted font-weight-medium">invoice-dec-2019.pdf</a>
                            ...
                            <div class="card mb-1 shadow-none border">
                                <div class="p-2">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col pl-0">
                                            <a href="javascript:void(0);" class="text-muted font-weight-medium">paypal-statement.docs</a>
                            ...
                            <div class="card mb-0 shadow-none border">
                                <div class="p-2">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col pl-0">
                                            <a href="javascript:void(0);" class="text-muted font-weight-medium">visa-credit-card.pdf</a>

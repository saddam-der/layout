                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless table-centered mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="../../../assets/images/products/product-1.png" alt="contact-img" title="contact-img" class="rounded mr-3" height="48" />
                                                        <p class="m-0 d-inline-block align-middle font-14 font-weight-medium">
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="../../../assets/images/products/product-2.png" alt="contact-img" title="contact-img" class="rounded mr-3" height="48" />
                                                        <p class="m-0 d-inline-block align-middle font-14 font-weight-medium">
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="../../../assets/images/products/product-3.png" alt="contact-img" title="contact-img" class="rounded mr-3" height="48" />
                                                        <p class="m-0 d-inline-block align-middle font-14 font-weight-medium">
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="../../../assets/images/products/product-5.png" alt="contact-img" title="contact-img" class="rounded mr-3" height="48" />
                                                        <p class="m-0 d-inline-block align-middle font-14 font-weight-medium">

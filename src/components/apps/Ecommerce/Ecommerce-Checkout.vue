                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="nav nav-pills flex-column navtab-bg nav-pills-tab text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        <a class="nav-link active show py-2" id="custom-v-pills-billing-tab" data-toggle="pill" href="#custom-v-pills-billing" role="tab" aria-controls="custom-v-pills-billing" aria-selected="true">
                                            <i class="mdi mdi-account-circle d-block font-24"></i>
                                            Billing Info
                                        </a>
                                        <a class="nav-link mt-2 py-2" id="custom-v-pills-shipping-tab" data-toggle="pill" href="#custom-v-pills-shipping" role="tab" aria-controls="custom-v-pills-shipping" aria-selected="false">
                                            <i class="mdi mdi-truck-fast d-block font-24"></i>
                                            Shipping Info</a>
                                        <a class="nav-link mt-2 py-2" id="custom-v-pills-payment-tab" data-toggle="pill" href="#custom-v-pills-payment" role="tab" aria-controls="custom-v-pills-payment" aria-selected="false">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-centered table-nowrap mb-0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="../../../assets/images/products/product-2.png" alt="product-img" title="product-img" class="rounded" height="48" />
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="../../../assets/images/products/product-3.png" alt="product-img" title="product-img" class="rounded mr-2" height="48" />
                                                        </td>
                                                        <td>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="border p-3 rounded mb-3 mb-md-0">
                                                            ...
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                ...
                                                                <label class="custom-control-label font-15 font-weight-bold" for="customRadio1">Home</label>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="border p-3 rounded mb-3 mb-md-0">
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                ...
                                                                <label class="custom-control-label font-15 font-weight-bold" for="customRadio2">Office</label>
                                                            </div>
                                                            <div class="float-right">
                                                                <a href="#"><i class="mdi mdi-square-edit-outline text-muted font-20"></i></a>
                                                            </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="border p-3 rounded mb-3">
                                                            <div class="custom-control custom-radio">
                                                                ...
                                                                <label class="custom-control-label font-15 font-weight-bold" for="shippingMethodRadio1">Standard Delivery - FREE</label>
                                                            </div>
                                                        ...
                                                        <div class="border p-3 rounded">
                                                            <div class="custom-control custom-radio">
                                                                ...
                                                                <label class="custom-control-label font-15 font-weight-bold" for="shippingMethodRadio2">Fast Delivery - $25</label>
                                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="border p-3 mb-3 rounded">
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        ...
                                                        <label class="custom-control-label font-15 font-weight-bold" for="BillingOptRadio2">Pay with Paypal</label>
                                                    </div>
                                                ...
                                                <div class="border p-3 mb-3 rounded">
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        ...
                                                        <label class="custom-control-label font-15 font-weight-bold" for="BillingOptRadio1">Credit / Debit Card</label>
                                                    </div>
                                                ...
                                                <div class="border p-3 mb-3 rounded">
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        ...
                                                        <label class="custom-control-label font-15 font-weight-bold" for="BillingOptRadio4">Cash on Delivery</label>
                                                    </div>

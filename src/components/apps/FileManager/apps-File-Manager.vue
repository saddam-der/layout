                    ...
                    <div class="card-box">
                        ...
                        <div class="inbox-leftbar">
                            ...
                            <div class="mail-list mt-3">
                                <a href="#" class="list-group-item border-0 font-14"><i class="mdi mdi-folder-outline font-18 align-middle mr-2"></i>My Files</a>
                                <a href="#" class="list-group-item border-0 font-14"><i class="mdi mdi-google-drive font-18 align-middle mr-2"></i>Google Drive</a>
                                <a href="#" class="list-group-item border-0 font-14"><i class="mdi mdi-dropbox font-18 align-middle mr-2"></i>Dropbox</a>
                                <a href="#" class="list-group-item border-0 font-14"><i class="mdi mdi-share-variant font-18 align-middle mr-2"></i>Share with me</a>
                                <a href="#" class="list-group-item border-0 font-14"><i class="mdi mdi-clock-outline font-18 align-middle mr-2"></i>Recent</a>
                                <a href="#" class="list-group-item border-0 font-14"><i class="mdi mdi-star-outline font-18 align-middle mr-2"></i>Starred</a>
                                <a href="#" class="list-group-item border-0 font-14"><i class="mdi mdi-delete font-18 align-middle mr-2"></i>Deleted Files</a>
                            </div>

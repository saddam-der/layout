                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card-box">
                            ...
                            <div v-for="dataProduct in data" :key="dataProduct.id">
                                <div class="form-group mb-3">
                                    <label for="product-name">Product Name <span class="text-danger">*</span></label>
                                    <input type="text" id="product-name" v-bind:value="dataProduct.name" class="form-control" placeholder="e.g : Apple iMac">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="product-description">Product Description <span class="text-danger">*</span></label>
                                    <ckeditor :editor="editor" v-bind:value="dataProduct.description"></ckeditor>
                                </div>

                                <div class="form-group mb-3">
                                    <label for="product-category">Categories <span class="text-danger">*</span></label>
                                    <select class="form-control select2" v-bind:value="dataProduct.category">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control" id="product-qty" v-bind:value="dataProduct.qty" placeholder="Enter Quantity">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="product-minimum">Minimum <span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" id="product-minimum" v-bind:value="dataProduct.minimum" placeholder="Enter Minimum">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="product-price">Amount <span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" id="product-price" v-bind:value="dataProduct.amount" placeholder="Enter amount">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="product-condition">Condition <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="product-condition" v-bind:value="dataProduct.condition" placeholder="Enter Condition">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="product-method">Method <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="product-method" v-bind:value="dataProduct.method" placeholder="Enter Method">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="product-image">Image <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="product-image" v-bind:value="dataProduct.image.img1" placeholder="Enter Method">
                                    <img :src="dataProduct.image.img1" alt="" width="140px">
                                    <img :src="dataProduct.image.img2" alt="" width="140px">
                                    <img :src="dataProduct.image.img3" alt="" width="140px">
                                    <img :src="dataProduct.image.img4" alt="" width="140px">
                                </div>
